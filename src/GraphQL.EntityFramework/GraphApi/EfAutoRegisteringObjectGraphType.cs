...
{
    public class EfAutoRegisteringObjectGraphType<TDbContext, TSource> :
        AutoRegisteringObjectGraphType<TSource>
        where TDbContext : DbContext
    {
        IEfGraphQLService<TDbContext> efGraphQlService;

        public EfAutoRegisteringObjectGraphType(IEfGraphQLService<TDbContext> efGraphQlService)
        {
